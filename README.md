...
```html
<div id="widget"></div>
<script src="https://cdn.jsdelivr.net/gh/rxog/se-qr-code@0.1.0/dist/widget.min.js"></script>
```

## CSS

```css
@import "https://cdn.jsdelivr.net/gh/rxog/se-qr-code@0.1.0/dist/widget.min.css";
...
```json
{
  ...
  "widgetAuthor": {
    "type": "hidden",
    "value": "Ronis Xogum <https://xog.me/>",
    "group": "Config"
  }
}
```

![QRcode Widget](assets/widget.png)
